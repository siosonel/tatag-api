...
class CronRecords extends Collection {
	...
	function get() {
		if ($_SERVER['REMOTE_ADDR']==$_SERVER['SERVER_ADDR'] OR $_SERVER['REMOTE_ADDR']=='127.0.0.1') {/*allowed*/}
		else Error::http(403, "Requests for the sim/records resource must originate from the server environment.");
